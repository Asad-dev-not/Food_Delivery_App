...
class AppColors {
  ...
  static final Color yellowColor2 = const Color(0xFFfa7552);
  static final Color skyblue1 = const Color(0xFF69c5df);
  static final Color purple1 = const Color(0xFF9294cc);
}
